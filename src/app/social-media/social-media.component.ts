...
export class SocialMediaComponent {
  constructor(library: FaIconLibrary) {
    library.addIcons(faTwitter, faDiscord, faGithub, faLinkedin, faPhone, faEnvelope, faInstagram, faXTwitter, faFacebook); // Ajouter uniquement les icônes spécifiques
  }
}
